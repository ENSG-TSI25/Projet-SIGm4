...
public:
    VectorLayer(const std::string& nom_, const std::string& crs_ = "EPSG:4326", double epoque_ = 0.0, std::string coords_type_ = "geographic")
        : Layer(nom_, crs_, epoque_, coords_type_) {}
